...
def test_action_ablation_promotion_rejects_a_collapsed_representation(monkeypatch):
    ...
    collapsed = SimpleNamespace(
        representation_diagnostics={"gate_evaluable": True, "passed": False},
        with_actions_stats={},
        without_actions_stats={},
    )
    monkeypatch.setattr(
        nursery_module, "run_action_ablation_eval", lambda *args, **kwargs: collapsed
    )
